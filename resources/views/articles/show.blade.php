...
<body class="bg-gray-50">
            ...
            <div class="py-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="{{ route('sections.show', $article->section->slug) }}" class="text-gray-600 hover:text-blue-600 transition-colors">
                    ...
                    <div class="flex items-center space-x-2">
                        <button onclick="shareOnFacebook()" class="p-2 text-blue-600 hover:bg-blue-50 rounded-full transition-colors">
                            <i class="fab fa-facebook-f"></i>
                        </button>
                        <button onclick="shareOnTwitter()" class="p-2 text-sky-500 hover:bg-sky-50 rounded-full transition-colors">
                            <i class="fab fa-twitter"></i>
                        </button>
                        <button onclick="copyToClipboard()" class="p-2 text-gray-600 hover:bg-gray-100 rounded-full transition-colors">
                            ...
                            <div class="bg-gray-100 rounded-lg overflow-hidden">
                                <video controls class="w-full h-64 object-cover">
                                    ...
                                    <p class="p-4 text-gray-600">
                                        ...
                                        <a href="{{ $video->getUrl() }}" class="text-blue-600 underline">Descargar video</a>
                                    </p>
                                </video>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li><a href="{{ route('sections.show', $article->section->slug) }}" class="text-gray-300 hover:text-white">{{ $article->section->name }}</a></li>
                        @auth
    ...
    <div id="imageModal" class="fixed inset-0 bg-black bg-opacity-75 hidden z-50 flex items-center justify-center p-4" onclick="closeImageModal()">
        <div class="max-w-4xl max-h-full relative">
            ...
            <div id="modalCaption" class="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white p-4 text-center"></div>
        </div>
    </div>
